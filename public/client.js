...
window.addEventListener('load', function() {
	...
	socket.on('SPAWN_PLAYER', function(id,name,avatar,dx,dy,dz,rotation) {
				      		
	  var currentUserAtr = id+':'+name+':'+avatar+':'+dx+':'+dy+':'+dz+':'+rotation;;
      if(unityInstance!=null)
		{
	...
	socket.on('UPDATE_POS_AND_ROT', function(id,dx,dy,dz,rotation) {
				      		
	  var currentUserAtr = id+':'+dx+':'+dy+':'+dz+':'+rotation;
	   if(unityInstance!=null)
		{
